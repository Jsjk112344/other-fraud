...
- [ ] **PIPE-03**: Agent navigates to the seller's profile page via TinyFish and extracts account age, total listings, listing categories, and review text/sentiment
