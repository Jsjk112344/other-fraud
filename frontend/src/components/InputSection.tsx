...
export function InputSection({
  ...
  const isInvestigate = activeMode === 'investigate';
  ...
  return (
    <div className="max-w-4xl mx-auto text-center">
      ...
      <div className="flex gap-2 justify-center mb-6">
        <button
          onClick={() => switchMode('investigate')}
      ...
      <div className="mt-8 group relative">
        ...
        <div className="relative bg-surface-container-low rounded-lg p-2 flex items-center gap-2 border border-outline-variant/20 focus-within:border-primary/50 transition-colors">
          ...
          {isRunning ? (
            ...
            >
              {isInvestigate ? 'Stop Investigation' : 'Stop Scan'}
            </button>
          ) : (
            <button
            ...
            >
              {isInvestigate ? 'Investigate Listing' : 'Scan Event'}
            </button>
          )}
        </div>
      </div>
